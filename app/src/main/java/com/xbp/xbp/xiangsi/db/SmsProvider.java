package com.xbp.xbp.xiangsi.db;
...
public class SmsProvider extends ContentProvider {
    ...
    private static final String AUTHORITY="com.xbp.xbp.xiangsi.provider.SmsProvider";
    public static final Uri URI_SMS_ALL=Uri.parse("content://"+AUTHORITY+"/xiangsi");
    private  static  UriMatcher matcher;
    private static  final int SMS_ALL=0;
    private static  final int SMS_ONE=1;
    static {
        matcher=new UriMatcher(UriMatcher.NO_MATCH);
        matcher.addURI(AUTHORITY,"xiangsi",SMS_ALL);
        matcher.addURI(AUTHORITY,"xiangsi/#",SMS_ONE);
    }
